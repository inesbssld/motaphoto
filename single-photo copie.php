        ...
        ?>
            ...
            <div class="navigation-links">
                ...
                <a href="<?php echo get_permalink($previous_photo->ID); ?>" class="nav-link prev-link"
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/img/arrow_left.png" alt="flèche précédente">
                </a>
                ...
                <a href="<?php echo get_permalink($next_photo->ID); ?>" class="nav-link next-link"
                    ...
                    <img src="<?php echo get_template_directory_uri(); ?>/img/arrow_right.png" alt="flèche suivante">
                </a>
...
?>
        ...
        <button class="load-more" id="load-more-category">Toutes les photos</button>
    </div>
